...
encrypt:
	...
	gpg --symmetric --cipher-algo AES256 sentrei/mobile/android/firebase/alpha/google-services.json
	gpg --symmetric --cipher-algo AES256 sentrei/mobile/android/firebase/beta/google-services.json
	gpg --symmetric --cipher-algo AES256 sentrei/mobile/android/firebase/master/google-services.json
	...
	gpg --symmetric --cipher-algo AES256 sentrei/mobile/ios/Firebase/alpha/GoogleService-Info.plist
	gpg --symmetric --cipher-algo AES256 sentrei/mobile/ios/Firebase/beta/GoogleService-Info.plist
	gpg --symmetric --cipher-algo AES256 sentrei/mobile/ios/Firebase/master/GoogleService-Info.plist
